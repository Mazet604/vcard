...
export default function VCardGenerator() {
    ...
    const renderError = (field: string | number | symbol): React.ReactNode => {
        const fieldKey = field as keyof FormDataType;
        return errors[fieldKey] && <div className="text-red-500 text-sm mt-1 flex items-center">
        ...
        <div className="min-h-screen bg-gradient-to-br from-red-50 via-white to-orange-50 py-8 px-4">
            <div className="max-w-6xl mx-auto">
                ...
                <div className="text-center mb-8">
                    ...
                    <h1 className="text-4xl font-bold text-gray-900 mb-2">VCard Generator</h1>
